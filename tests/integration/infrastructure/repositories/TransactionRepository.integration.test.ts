...
describe("TransactionRepository - Integration with IndexedDB", () => {
  ...
  describe("Read", function () {
    const transactions: Array<Transaction> = [createTransactionStub(), createTransactionStub()]
    ...
    it("Should be able to read all transactions", async () => {
      // Arrange - noOp
      // Act
    ...
    it("Should be able to read a transaction", async () => {
      // Arrange
